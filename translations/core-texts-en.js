...
const en_Translations = {
    ...
    "1000-privacy-policy": "Privacy policy",
    ...
    "3000-buwana-privacy-full": "<p style=\"font-size:medium;\">Last revised: April 18, 2025</p>\n" +
        ...
        "  <li>We use your data solely to support GoBrik’s ecological and community goals.</li>\n" +
        "  <li>You have full control over your data and account.</li>\n" +
        "  <li>You can delete your Buwana or $client_app account and data from our servers at any time.</li>\n" +
        "</ul>\n" +
        "\n" +
        ...
        "  <li>Your community connection data.</li>\n" +
        ...
        "  <li>Your neighbourhoud location (we will never ask for your precise address)</li>\n" +
        ...
        "  <li>Send your account notificatins emails</li>\n" +
        "  <li>Send you your chosen Earthen newsletter subscriptions</li>\n" +
        "  <li>Enable the $client_app to register you in to their service.</li>\n" +
        "  <li>Enable the $client_app to authenticate you in and out of their service.</li>\n" +
        ...
        "  <li>User credentials are kept in a seperate table from user details</li>\n" +
        ...
        "<ul>\n" +
        "  <li>Open the “Account Settings” menu in the top-left corner of the $client_app.</li>\n" +
        "  <li>Select “Edit Profile” to change your details.</li>\n" +
        "  <li>We use the Ghost newsletter platform.  For full \n" +
        ...
        "<p>We are a human-centered, Earth-focused enterprise. If you have questions or concerns about this policy, please contact us at <a href=\"mailto:earthen@ecobricks.org\">earthen@ecobricks.org</a>.</p>\n" +
        "\n" +
        "<h2>Final Words</h2>\n" +
