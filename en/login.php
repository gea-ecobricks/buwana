...
<form id="login" method="post" action="../processes/login_process_jwt.php">
    ...
    <div class="form-item">
                        ...
                        <div class="form-item" id="password-form" style="height:111px;margin-top: -15px;">
                        ...
                        <div class="form-item" id="code-form" style="text-align:center;height:111px;margin-top:-15px;">
