...
<button type="submit" id="submit-button" class="kick-ass-submit">
  ...
  <span id="submit-emoji" class="submit-emoji" style="display: none;"></span>
    ...
    <div style="font-size: medium; text-align: center; margin: auto; align-self: center;padding-top:40px;padding-bottom:50px;margin-top: 0px;">
        <p style="font-size:medium;line-spacing:1.3em;"><span data-lang-id="000-already-have-account">Already have an account?</span> <br> <a href="<?= htmlspecialchars($app_info['app_url']) ?>/"><span data-lang-id="000-login-to"> Login to <?= htmlspecialchars($app_info['app_display_name']) ?> ↗</a>.</p>
    </div>
</div>
