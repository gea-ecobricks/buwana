<title>Set your <?= htmlspecialchars($app_info['app_display_name']) ?> password | Buwana Accounts</title>

<meta name="keywords" content="buwana, register, signup, sign up, sign, up">
<meta name="description" content="Set your Buwana account password to use on <?= htmlspecialchars($app_info['app_display_name']) ?>">
...
<meta property="og:description"   content="Set your Buwana account password to use on <?= htmlspecialchars($app_info['app_display_name']) ?>" >
